...
{
    private double[] TPRArr;  //TPR数组
    private double[] FPRArr;   //FPR数组

    private XYDataset createDataset()
    {
        XYSeries xyseries1=new XYSeries("ROC曲线");
    ...
    private JFreeChart createChart(XYDataset dataset)
    {
        ...
        //设置主标题
        chart.setTitle(new TextTitle("ROC曲线分析图", new Font("隶书", Font.ITALIC, 15)));
