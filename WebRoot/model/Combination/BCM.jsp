...
<html>
	...
	<body>
		...
		<div class="titlename">贝叶斯组合模型</div>
		<div id="main_tab"> 
			<div class="main_tab_menu">
				<ul> 
					<li id="BCM_tab1" onClick="setTab('BCM',1,4)" class="hover">模型简介</li> 
					<li id="BCM_tab2" onClick="setTab('BCM',2,4)" >失效数据</li> 
					<li id="BCM_tab3" onClick="setTab('BCM',3,4)">模型选择</li>
					<li id="BCM_tab4" onClick="setTab('BCM',4,4)" 
			...
			<div class="main_tab_content">
				...
				<div class="scrollbox">
						<p style="text-align:center;"><img src="../../IMAGE/com/BW.jpg"></p>
				</div>
				</div>
				<div id="BCM_con2" style="display:none">
				...
				<div id="BCM_con3" style="display:none">
					...
					<div class="setup" style="height:84%">
						<form action="../../resultshow/resultCombination.jsp" method="post"
							...
							<div class="parametersetup_title">类型：</div>
							<div class="parametersetup_content">
								<select name="type">
									<option value="1" selected>一般型</option>
	...
	<!-- **********************************增加模型接口********************************** -->
						...
						<%	}%>
							<div style="text-align:center">
								<input type="hidden" id="model" name="model" value="BCM">
				...
				<div id="BCM_con4" style="display:none">
					<iframe name="SHOWDATA_BCM" src="../../resultshow/resultCombination.jsp"></iframe>
				</div>
			</div>		
		</div>
	</body>
