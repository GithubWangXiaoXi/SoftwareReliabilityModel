...
<html>
	...
	<body>
		...
		<div class="titlename">非线性加权组合模型</div>
		<div id="main_tab"> 
			<div class="main_tab_menu">
				<ul> 
					<li id="NLW_tab1" onClick="setTab('NLW',1,4)" class="hover">模型简介</li> 
					<li id="NLW_tab2" onClick="setTab('NLW',2,4)" >失效数据</li> 
					<li id="NLW_tab3" onClick="setTab('NLW',3,4)">模型选择</li>
					<li id="NLW_tab4" onClick="setTab('NLW',4,4)" style="display:none">分析结果</li> 
				</ul>
			</div>
			<div class="main_tab_content">
				<div id="NLW_con1">
					...
					<div class="scrollbox">
						<p style="text-align:center;"><img src="../../IMAGE/com/NLW.jpg"></p>
				</div>
				</div>
				<div id="NLW_con2" style="display:none">
	...
	<!-- **********************************增加模型接口********************************** -->
						...
						<%	}%>
							<div style="text-align:center">
								<input type="hidden" id="model" name="model" value="NLW">
				...
				<div id="NLW_con4" style="display:none">
					<iframe name="SHOWDATA_NLW" src="../../resultshow/resultCombination.jsp"></iframe>
				</div>
			</div>		
		</div>
	</body>
