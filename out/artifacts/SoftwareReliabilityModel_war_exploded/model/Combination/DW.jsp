...
<html>
			...
			<div class="main_tab_content">
				<div id="DW_con1">
					<div class="subtitle">模型简介</div>
										<div class="scrollbox">
						<p style="text-align:center;"><img src="../../IMAGE/com/DW.jpg"></p>
				</div>
				</div>
				...
				<div id="DW_con3" style="display:none">
					...
					<div class="setup" style="height:84%">
						<form action="../../resultshow/resultCombination.jsp" method="post"
								target="SHOWDATA_DW" onsubmit="return validate_Combination(this);">
	...
	<!-- **********************************增加模型接口********************************** -->
				...
				<div id="DW_con4" style="display:none">
					<iframe name="SHOWDATA_DW" src="../../resultshow/resultCombination.jsp"></iframe>
				</div>
			</div>		
		</div>
	</body>
