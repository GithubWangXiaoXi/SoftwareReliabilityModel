...
<html>
	...
	<body>
		...
		<div class="titlename">线性加权组合模型</div>
		<div id="main_tab"> 
			<div class="main_tab_menu">
				<ul> 
					<li id="LW_tab1" onClick="setTab('LW',1,4)" class="hover">模型简介</li> 
					<li id="LW_tab2" onClick="setTab('LW',2,4)" >失效数据</li> 
					<li id="LW_tab3" onClick="setTab('LW',3,4)">模型选择</li>
					<li id="LW_tab4" onClick="setTab('LW',4,4)" style="display:none">分析结果</li> 
				</ul>
			</div>
			<div class="main_tab_content">
				<div id="LW_con1">
					<div class="subtitle">模型简介</div>
															<div class="scrollbox">
						<p style="text-align:center;"><img src="../../IMAGE/com/LW.jpg"></p>
				</div>
				<div id="LW_con2" style="display:none">
	...
	<!-- **********************************增加模型接口********************************** -->
						...
						<%	}%>
							<div style="text-align:center">
								<input type="hidden" id="model" name="model" value="LW">
				...
				<div id="LW_con4" style="display:none">
					<iframe name="SHOWDATA_LW" src="../../resultshow/resultCombination.jsp"></iframe>
				</div>
			</div>		
		</div>
	</body>
