...
<html>
	...
	<body>
		...
		<div class="titlename">服务池容错模型</div>
		<div id="main_tab"> 
...
失效同样也可以认为是随机的。
		...
		$(function () {
			$('#snum').blur(function () {
				...
				var html1='<table contenteditable="true" class="table table-bordered"><thead><th>服务编号</th><th>服务失效率</th><th>连接失效率</th></thead>';
				var tbody='';
				for(var i=0;i<num;i++){
