...
<% 
	...
	int changeflag = 0;		//声明一个数据替代标志，用于判断当前数据inputdata有没有被替代
   	if(request.getParameter("changenumber") != null)	//替代当前数据
   	{
   		...
   		rt.updateDefaultSet2(historydata.getdataname(n), Integer.parseInt(request.getParameter("showhistorydata_testpercentage")));
	...
	<body>
	 	<div class="show_tab_menu" >
			...
			<div class="changedata" >
				...
				onsubmit="return validate_changedata2(this)" id="changeform">
					<br><br>
					测试数据比例:
